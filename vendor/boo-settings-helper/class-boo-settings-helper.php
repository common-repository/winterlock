 ...
 */
if ( ! class_exists( 'Boo_Settings_Helper2' ) ):

	class Boo_Settings_Helper2 {
...
//		protected $options_id;
		...
		public function get_default_settings_url() {
			...
			$options_base_file_name = $this->config_menu['submenu'] ? 'admin.php' : 'admin.php';
...
//			$name          = $this->get_field_name( $args['options_id'], $args['section'], $args['id'] );
		...
		function script_general() {
			...
			require_once(WINTER_ACTIVITY_LOG_PATH.'application/views/general/footer.php');

...
<h1><?php echo __('Control Security','winter-activity-log'); ?></h1>

<div class="winterlock_wrap">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo __('Control Security Rules Data','winter-activity-log'); ?></h3>
        </div>
    ...
    <div class="alert alert-info" role="alert"><?php echo __('Based on any rules criteria defined here you will block user specific actions.', 'winter-activity-log'); ?></div>

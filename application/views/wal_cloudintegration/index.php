...
?></th>
            ...
            <div class="footer-btns">
                <a href="#bulk_remove-form" id="bulk_remove" class="page-title-action pull-right popup-with-form"><i class="fa fa-remove"></i>&nbsp;&nbsp;<?php 
...
?>'))
            {
                ...
                $.post('<?php 
menu_page_url( 'wal_cloudintegration', true );
?>&function=bulk_remove', { cloud_ids: ids }, function(data) {

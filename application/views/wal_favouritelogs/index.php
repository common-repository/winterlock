...
<h1><?php echo __('Favourite Logs','winter-activity-log'); ?></h1>

<div class="winterlock_wrap">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo __('Saved/Favourite Logs Data','winter-activity-log'); ?></h3>
        </div>
                    ...
                    <table id="din-table" class="table table-striped" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th data-priority="3"><i class="glyphicon glyphicon-lock"></i> <i class="glyphicon glyphicon-eye-close"></i> <i class="glyphicon glyphicon-heart"></i> <i class="glyphicon glyphicon-search"></i></th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th><input type="text" placeholder="<?php echo __('Filter Level', 'winter-activity-log'); ?>" /></th>
                                <th><input type="text" id="filter_date" placeholder="<?php echo __('Filter Date From', 'winter-activity-log'); ?>" /></th>
                                <th></th>
                                <th><input type="text" placeholder="<?php echo __('Filter User', 'winter-activity-log'); ?>" /></th>
                                <th><input type="text" placeholder="<?php echo __('Filter IP', 'winter-activity-log'); ?>" /></th>
    ...
    <div class="alert alert-warning" role="alert"><?php echo __('Saved logs will not be removed automatically', 'winter-activity-log'); ?></div>
    ...
    $('#bulk_remove').click(function(){
        ...
        else
        {
            ...
            if(confirm('<?php esc_js(__('Are you sure?', 'winter-activity-log')); ?>'))
            {
                ...
                // ajax to remove rows
                $.post('<?php menu_page_url( 'winteractivitylog', true ); ?>&function=bulk_remove', { log_ids: ids }, function(data) {
		...
		var table = $('#din-table').DataTable({
            ...
            'ajax': {
                ...
                "data": function ( d ) {
                    ...
                    return $.extend( {}, d, {
                        "page": 'wal_favouritelogs',
                        "function": 'datatable_saved',

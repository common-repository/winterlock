...
<h1><?php echo __('Disabled Logs','winter-activity-log'); ?></h1>

<div class="winterlock_wrap">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title"><?php echo __('Skip/Disabled Logs Data','winter-activity-log'); ?></h3>
        </div>
    ...
    <div class="alert alert-info" role="alert"><?php echo __('All logs covered by this rules criteria will not be logged at all. This helps you to reduce logs number and skip unimportant logs for you', 'winter-activity-log'); ?></div>
